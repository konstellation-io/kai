...
| adminApi.image.tag | string | `"0.3.0-develop.8"` | Image tag |
...
| k8sManager.image.tag | string | `"0.3.0-develop.8"` | Image tag |
...
| nats.serviceAccount.enabled | bool | `true` |  |
...
| natsManager.image.tag | string | `"0.3.0-develop.8"` | Image tag |
