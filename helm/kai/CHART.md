...
| adminApi.image.tag | string | `"0.2.0-develop.77"` | Image tag |
...
| k8sManager.image.tag | string | `"0.2.0-develop.77"` | Image tag |
...
| natsManager.image.tag | string | `"0.2.0-develop.77"` | Image tag |
