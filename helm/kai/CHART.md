...
| adminApi.image.tag | string | `"0.3.0-hotfixupdatereadmeurls.1"` | Image tag |
...
| k8sManager.image.tag | string | `"0.3.0-hotfixupdatereadmeurls.1"` | Image tag |
...
| natsManager.image.tag | string | `"0.3.0-hotfixupdatereadmeurls.1"` | Image tag |
