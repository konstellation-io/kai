...
func (_m *VersionServiceMock) GetPublishedTriggers(ctx context.Context, product string) (map[string]string, error) {
...
// VersionServiceMock_GetPublishedTriggers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetPublishedTriggers'
type VersionServiceMock_GetPublishedTriggers_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - product string
func (_e *VersionServiceMock_Expecter) GetPublishedTriggers(ctx interface{}, product interface{}) *VersionServiceMock_GetPublishedTriggers_Call {
	return &VersionServiceMock_GetPublishedTriggers_Call{Call: _e.mock.On("GetPublishedTriggers", ctx, product)}
}

func (_c *VersionServiceMock_GetPublishedTriggers_Call) Run(run func(ctx context.Context, product string)) *VersionServiceMock_GetPublishedTriggers_Call {
...
func (_c *VersionServiceMock_GetPublishedTriggers_Call) Return(_a0 map[string]string, _a1 error) *VersionServiceMock_GetPublishedTriggers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *VersionServiceMock_GetPublishedTriggers_Call) RunAndReturn(run func(context.Context, string) (map[string]string, error)) *VersionServiceMock_GetPublishedTriggers_Call {
	_c.Call.Return(run)
	return _c
}
